...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.loading": "載入中...",
    "sidebar.switchToFlatView": "切換為平鋪會話列表",
    "sidebar.switchToProjectView": "切換為按專案分組列表",
    "sidebar.noRecentSessions": "近 24 小時沒有會話活動",
    "sidebar.showOlderSessions": "顯示更早的 {count} 個會話",
    "sidebar.hideOlderSessions": "隱藏更早的會話",
    "sidebar.unhide": "恢復顯示",
    "sidebar.pin": "置頂",
    "sidebar.unpin": "取消置頂",
    "sidebar.pinned": "已置頂",
    ...
    "chat.selectProject": "選擇專案",
    "chat.selectBranch": "選擇分支",
    "chat.sessionModifiedFiles": "修改的檔案",
    "chat.sessionModifiedFilesCount": "共修改 {count} 個檔案",
    "chat.loadingSkills": "正在載入 Skill...",
    "chat.skillsHeader": "Skill · {label}",
    "chat.noMatchingSkills": "未找到相符的 Skill",
    "chat.dropFilesToUpload": "釋放檔案上傳至主機 /tmp 目錄",
    "chat.uploadingFile": "正在上傳 {name} ({progress}%)...",
    "chat.uploadFailed": "上傳失敗：{name}",
    "chat.uploadPending": "請等待檔案上傳完成後再發送",
    "chat.openInFileViewer": "在檔案預覽窗格中開啟",
    "chat.imageLoadFailed": "圖片載入失敗",
    ...
    "askUser.title": "需要確認",
    "askUser.showSource": "檢視 ask-user 原始碼",
    "askUser.showForm": "返回表單",
    "askUser.progress": "第 {current} 題，共 {total} 題",
    "askUser.recommended": "推薦",
    "askUser.other": "其他",
    "askUser.otherDescription": "填寫不在以上選項中的答案。",
    "askUser.supplement": "補充說明（選填）",
    "askUser.supplementPlaceholder": "補充選擇此項的背景或要求...",
    "askUser.customAnswer": "你的答案",
    "askUser.customPlaceholder": "請輸入你的答案...",
    "askUser.previous": "上一題",
    "askUser.next": "下一題",
    "askUser.insert": "填入輸入框",
    "askUser.inserted": "已填入輸入框",
    "askUser.continued": "對話已繼續",
    "askUser.answerIntro": "以下是我的回答：",
    "askUser.answerChoice": "選擇",
    "askUser.answerSupplement": "補充",
    "askUser.answerCustom": "回答",
    ...
    "chat.suggestReplies": "建議回覆",
    "chat.suggestedReplies": "建議回覆",
    "chat.generatingSuggestedReplies": "正在產生建議回覆…",
    ...
    "i18n.fullscreen": "全螢幕預覽",
    "i18n.exitFullscreen": "退出全螢幕",
    ...
    "push.enable": "開啟通知",
    "push.disable": "關閉通知",
    "push.enabled": "已開啟任務通知",
    "push.disabled": "未開啟任務通知",
    "push.enableTitle": "任務完成時收到系統通知",
    "push.disableTitle": "關閉任務完成通知",
    "push.denied": "通知權限被拒絕，請在瀏覽器設定中允許",
    "push.unsupported": "當前瀏覽器不支援推送通知",
  },
};
