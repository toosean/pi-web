...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.refresh": "刷新",
    "sidebar.switchToFlatView": "切换为平铺会话列表",
    "sidebar.switchToProjectView": "切换为按项目分组列表",
    ...
    "sidebar.noRecentSessions": "近 24 小时没有会话活动",
    "sidebar.showOlderSessions": "显示更早的 {count} 个会话",
    "sidebar.hideOlderSessions": "隐藏更早的会话",
    "sidebar.unhide": "恢复显示",
    ...
    "askUser.title": "需要确认",
    "askUser.showSource": "查看 ask-user 源码",
    "askUser.showForm": "返回表单",
    "askUser.progress": "第 {current} 题，共 {total} 题",
    "askUser.recommended": "推荐",
    "askUser.other": "其他",
    "askUser.otherDescription": "填写不在以上选项中的答案。",
    "askUser.supplement": "补充说明（可选）",
    "askUser.supplementPlaceholder": "补充选择此项的背景或要求...",
    "askUser.customAnswer": "你的答案",
    "askUser.customPlaceholder": "请输入你的答案...",
    "askUser.previous": "上一题",
    "askUser.next": "下一题",
    "askUser.insert": "填入输入框",
    "askUser.inserted": "已填入输入框",
    "askUser.continued": "对话已继续",
    "askUser.answerIntro": "以下是我的回答：",
    "askUser.answerChoice": "选择",
    "askUser.answerSupplement": "补充",
    ...
    "chat.loadingSkills": "正在加载 Skill...",
    "chat.skillsHeader": "Skill · {label}",
    "chat.noMatchingSkills": "未找到匹配的 Skill",
    "chat.searchingAll": " · 正在搜索所有文件…",
    "chat.indexTruncated": " · 索引不完整",
    "chat.steerPlaceholder": "立即引导 / 排队后续消息...",
    "chat.agentPlaceholder": "Agent 运行中…",
    "chat.dropFilesToUpload": "释放文件上传至主机 /tmp 目录",
    "chat.uploadingFile": "正在上传 {name} ({progress}%)...",
    "chat.uploadFailed": "上传失败：{name}",
    "chat.uploadPending": "请等待文件上传完成后再发送",
    "chat.messagePlaceholder": "消息…输入 / 使用命令，@ 查找文件，$ 选取 Skill",
    "chat.steer": "引导",
    "chat.followUp": "后续消息",
    ...
    "chat.suggestReplies": "建议回复",
    "chat.suggestedReplies": "建议回复",
    "chat.generatingSuggestedReplies": "正在生成建议回复…",
    "chat.refreshSuggestedReplies": "重新生成回复",
    "chat.retrySuggestedReplies": "重试",
    "chat.suggestedRepliesInvalid": "服务器没有返回可用的建议回复。",
    "chat.insertSelectedReplies": "插入已选（{count}）",
    ...
    "push.enable": "开启通知",
    "push.disable": "关闭通知",
    "push.enabled": "已开启任务通知",
    "push.disabled": "未开启任务通知",
    "push.enableTitle": "任务完成时收到系统通知",
    "push.disableTitle": "关闭任务完成通知",
    "push.denied": "通知权限被拒绝，请在浏览器设置中允许",
    "push.unsupported": "当前浏览器不支持推送通知",
    "i18n.after": "之后",
