...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.switchToFlatView": "Switch to flat session list",
    "sidebar.switchToProjectView": "Switch to project grouped session list",
    ...
    "sidebar.noRecentSessions": "No session activity in the last 24 hours",
    "sidebar.showOlderSessions": "Show {count} older sessions",
    "sidebar.hideOlderSessions": "Hide older sessions",
    "sidebar.unhide": "Restore",
    ...
    "chat.sessionModifiedFilesCount": "{count} files modified",
    ...
    "askUser.title": "Questions",
    "askUser.showSource": "View ask-user source",
    "askUser.showForm": "Return to form",
    "askUser.progress": "{current} of {total}",
    "askUser.recommended": "Recommended",
    "askUser.other": "Other",
    "askUser.otherDescription": "Provide an answer not covered by the options.",
    "askUser.supplement": "Additional details (optional)",
    "askUser.supplementPlaceholder": "Add context for this choice...",
    "askUser.customAnswer": "Your answer",
    "askUser.customPlaceholder": "Enter your answer...",
    "askUser.previous": "Previous",
    "askUser.next": "Next",
    "askUser.insert": "Fill input",
    "askUser.inserted": "Filled in input",
    "askUser.continued": "Conversation continued",
    "askUser.answerIntro": "Here are my answers:",
    "askUser.answerChoice": "Choice",
    "askUser.answerSupplement": "Additional details",
    "askUser.answerCustom": "Answer",
    "askUser.answerSeparator": ": ",
    "chat.close": "Close",
    ...
    "chat.skillsHeader": "Skills · {label}",
    ...
    "chat.dropFilesToUpload": "Drop files here to upload to host /tmp",
    "chat.uploadingFile": "Uploading {name} ({progress}%)...",
    "chat.uploadFailed": "Upload failed: {name}",
    "chat.uploadPending": "Please wait for file uploads to complete before sending",
    "chat.messagePlaceholder": "Message… Type / for commands, @ for files, $ for skills",
    "chat.steer": "Steer",
    ...
    "chat.suggestReplies": "Reply ideas",
    "chat.suggestedReplies": "Suggested replies",
    "chat.generatingSuggestedReplies": "Generating suggested replies…",
    ...
    "chat.openInFileViewer": "Open in file viewer",
    ...
    "push.enabled": "Task notifications on",
    "push.disabled": "Task notifications off",
    "push.enableTitle": "Get a system notification when a task finishes",
    "push.disableTitle": "Turn off task notifications",
    "push.denied": "Notification permission denied. Allow it in your browser settings.",
