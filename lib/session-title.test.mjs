...
test("isAutoGenerateTitleEnabled defaults to true and respects environment flags", () => {
  assert.equal(isAutoGenerateTitleEnabled({}), true);
  assert.equal(isAutoGenerateTitleEnabled({ PI_WEB_AUTO_GENERATE_TITLE: "true" }), true);
  assert.equal(isAutoGenerateTitleEnabled({ PI_WEB_AUTO_GENERATE_TITLE: "1" }), true);
  assert.equal(isAutoGenerateTitleEnabled({ PI_WEB_AUTO_GENERATE_TITLE: "false" }), false);
  assert.equal(isAutoGenerateTitleEnabled({ PI_WEB_AUTO_GENERATE_TITLE: "0" }), false);
  assert.equal(isAutoGenerateTitleEnabled({ PI_WEB_AUTO_GENERATE_TITLE: "off" }), false);
  assert.equal(isAutoGenerateTitleEnabled({ PI_WEB_AUTO_GENERATE_TITLE: "no" }), false);
  assert.equal(isAutoGenerateTitleEnabled({ PI_WEB_AUTO_GENERATE_TITLE: "disabled" }), false);
  assert.equal(isAutoGenerateTitleEnabled({ PI_WEB_AUTO_TITLE: "false" }), false);
});
